...
const Login = () => {
  return (
    ...
    <div className='h-[500px] w-11/12 sm:w-[475px] bg-white rounded-[20px] p-5 flex flex-col items-center'>
        ...
        <div className='my-2'>
            ...
            <p className='font-montserrat text-labelColor text-label mt-1'>Enter your credentials to access your account</p>
        </div>
